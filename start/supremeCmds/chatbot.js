...
async function handleAIChatbot(m, supreme, body, from, isGroup, isCmd, prefix) {
    try {
        ...
        await supreme.sendPresenceUpdate('composing', from);
        ...
        if (isAskingAboutCreator) {
            ...
            response = "I am JEXPLOIT AI, created by Supreme Tech - a brilliant developer from Uganda with exceptional coding skills and vision. He's the mastermind behind my existence, crafting me with precision and care to be your helpful assistant.";
        } else {
            ...
            const prompt = `You are Jexploit AI, a powerful WhatsApp bot developed by Supreme Tech from Uganda. 
